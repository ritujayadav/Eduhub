...
exports.studentContact = async (req, res) =>
{
  ...
  try
  {
    ...
    if (student)
    {
      ...
      <p>Feel free to send us your suggestions anytime. Have any query related to EduHub 🤔 ? Do contact us. ✋ </p>
      <hr/>
      <h3 style="text-align:center"><a href=${ link }>Visit EduHub💡 again !</a></h3>
      <hr/>
      ...
      await sendEmail(
        email,
        "Thanks for getting in touch with EduHub ",
        studentcontent
      );

      const admincontent = `<h3 style="text-align:center"> Hey Rituja ! You have got a contact message from EduHub !</h3>
      
      <p>${ name } has contacted you on EduHub. We have sent him a thank you mail. </p>
