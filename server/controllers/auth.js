...
exports.studentForgotPassword = async (req, res) =>
{
  ...
  try
  {
    ...
    if (student)
    {
      ...
      const content = `<h3 style="text-align:center"> Reset your password on EduHub and continue Learning 👍</h3>
...
exports.teacherForgotPassword = async (req, res) =>
{
  ...
  try
  {
    ...
    if (teacher)
    {
      ...
      const content = `<h3 style="text-align:center">Reset your password on EduHub and continue Teaching 👍</h3>
