            ...
            <div className="footer__main-content">
                <div className="footer_top">
                    <div className="footer_top_box">
                        ...
                        <p>Enjoy free access to all EduHub resources and study material anytime, anywhere from your comfort and ace
                        ...
                        <div className="footer_top_contact">
                            ...
                            <div className="text">
                                <span className="text">+91 921339433</span>
                                <span className="text">edupreneurs@gmail.com</span>
                    ...
                    <div className="bottom_content">
                        <div className="footer_bottom_name">
                            ...
                            <p>Struggling to choose right career path? Having difficulty in some topic or question?
                                <br></br>
                                Don't worry!! Enjoy free access to all EduHub resources and study material anytime, anywhere from your comfort and ace
                    ...
                    <div className="copyright">
                        <center>
                            <span className="credit"><a
                                href="#" style={{ color: "white", textDecoration: 'none', marginTop: "0.5rem" }}>EduHub</a> | </span>
